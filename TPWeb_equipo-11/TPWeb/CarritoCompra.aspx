                    ...
                    <asp:Repeater ID="rpArticulos" runat="server">
                        ...
                        <ItemTemplate>
                            ...
                            <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                                <asp:LinkButton ID="btnEliminarArticulo" runat="server" CssClass="text-danger" OnClick="btnEliminarArticulo_Click" CommandName="Id" CommandArgument='<%# Eval("oArticulo.Id")%>'>
