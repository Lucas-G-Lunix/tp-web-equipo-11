            ...
            <div class="container my-3">
                <div class="row my-1">
                    <div class="input-group rounded my-2">
                        <asp:TextBox ID="txtFiltrar" runat="server" OnTextChanged="txtFiltrar_TextChanged" AutoPostBack="true" CssClass="form-control rounded" placeholder="Buscar" aria-describedby="search-addon"></asp:TextBox>
